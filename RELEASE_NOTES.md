...
- Refresh: `2026-06-29T18:25:59Z` public evidence now shows `total_reports=3261`, `ready=3090`, `developer_tool_hit=13`, `agent_crawler_hit=6`, `x402_probe=24`, `human_visit=10`, `402_responses=24`, and `paid_calls=0`; the repeated probe/tool movement keeps the decision at revise until a paid call, request issue, subscription intent, or endpoint-owner reply appears.
